              ...
              <InfoCard>
                <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', lineHeight: 1.8 }}>
                  ...
                  {[
                    ...
                    { icon: '📦', title: '1段6個 / 5個 / 4個', desc: '従来の1ケース8個入りは1段6個（3列×2行）。12個入りの大きい箱は、100サイズ（3L JPV-T100）が奥に横2個＋手前に縦3個の1段5個・5段、180サイズ（5L JPV-T180）が風車状の1段4個・4段。段ごとに向きを変えて噛み合わせる。' },
