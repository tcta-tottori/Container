    ...
    override suspend fun loadContainers(): List<ContainerRecord> {
        ...
        return listOf(
            record(
                ...
                cargo = listOf(
                    item("1", "ポリカバー 30cm 白", ItemTypes.POLY_COVER, pallets = 4, cartons = 5, perPallet = 30, perCarton = 4, "前方 パレット1-4", "完了"),
                    item("2", "ポリカバー 36cm 白", ItemTypes.POLY_COVER, pallets = 3, cartons = 0, perPallet = 30, perCarton = 4, "前方 パレット5-7", "作業中"),
                    item("3", "ジャーポット PDU-3.0L", ItemTypes.JAR_POT, pallets = 2, cartons = 8, perPallet = 20, perCarton = 2, "中央 パレット8-10", "未着手"),
                    item("4", "ジャーポット PDZ-4.0L", ItemTypes.JAR_POT, pallets = 2, cartons = 4, perPallet = 20, perCarton = 2, "中央 パレット11-13", "未着手"),
                    item("5", "鍋 26cm IH", ItemTypes.POT, pallets = 3, cartons = 6, perPallet = 24, perCarton = 4, "後方 パレット14-17", "未着手"),
                    item("6", "ヤーマン部品 ヒーターユニット", ItemTypes.YAMAN_PARTS, pallets = 1, cartons = 5, perPallet = 40, perCarton = 6, "後方 パレット18-19", "未着手"),
            ...
            record(
                ...
                cargo = listOf(
                    item("1", "ポリカバー 24cm 透明", ItemTypes.POLY_COVER, pallets = 5, cartons = 0, perPallet = 30, perCarton = 4, "前方", "未着手"),
                    item("2", "鍋 22cm ガス", ItemTypes.POT, pallets = 3, cartons = 12, perPallet = 24, perCarton = 4, "中央", "未着手"),
            ...
            record(
                ...
                cargo = listOf(
                    item("1", "ジャーポット PDU-2.5L", ItemTypes.JAR_POT, pallets = 4, cartons = 0, perPallet = 20, perCarton = 2, "前方", "完了"),
                    item("2", "ジャーポット PDZ-3.0L", ItemTypes.JAR_POT, pallets = 3, cartons = 5, perPallet = 20, perCarton = 2, "中央", "完了"),
