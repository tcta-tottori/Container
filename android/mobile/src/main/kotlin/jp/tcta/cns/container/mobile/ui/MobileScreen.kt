    ...
    Card(onClick = onSelect, modifier = Modifier.fillMaxWidth()) {
        Row(
            ...
            Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                    Text(stringResource(R.string.label_quantity, DisplayFormat.quantity(info.totalQuantity)), style = MaterialTheme.typography.bodySmall)
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(2.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    stringResource(R.string.label_quantity_short, DisplayFormat.quantity(item.quantity)),
